  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          <a href="<?php echo base_url(); ?>index.php/public/Home_User">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>index.php/public/C_pendaftaran/tampil_view"><i class="fa fa-fw fa-file"></i> Data Pendaftar</a></li>
          </ul>
        </li>
