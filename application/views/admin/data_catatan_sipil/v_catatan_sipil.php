                                        ...
                                        if (count($temp) < 1) {
                                            ...
                                            foreach ($temp as $tem) {
                                                ...
                                                <tr>    
                                                    ...
                                                    <td scope="col"><a href="<?php echo base_url().'index.php/admin/C_admin/tabel_dps/'. $tem->desa?>"><?php echo $tem->desa; ?></a></td>
                                                <input type="hidden" name="nomor" value="<?php echo $tem->no; ?>">             
                                                <td scope="col"><a name="edit" href="<?php echo base_url() . 'index.php/admin/C_admin/sipil_dps_s/' . $tem->no; ?>"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a name="hapus" href="<?php echo base_url() . 'index.php/admin/C_admin/sipil_dps_h/' . $tem->no; ?>" onclick="return confirm('Anda yakin akan menghapus data ini... ?')"><i class="glyphicon glyphicon-trash"></i></a></td>
                                                </tr>                                       
                                                <?php
                                            }
                                        }
                                        ?>
                                        <tr><td colspan="7"><button name="sipiladd" class="btn btn-primary" value="tambah">Tambah</button></td></tr>
