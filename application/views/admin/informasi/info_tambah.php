                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-info-sign"></i> Tambah Data informasi
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                          <form name="userfile" action="<?php echo base_url(); ?>index.php/admin/C_admin/tambah_info" enctype="multipart/form-data" method="POST">
