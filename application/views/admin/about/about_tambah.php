                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-info-sign"></i> Tambah Data About
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                          <form name="userfile" action="<?php echo base_url(); ?>index.php/admin/C_admin/tambah_about" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" class="form-control" name="isi" placeholder="Isi"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Gambar</label>
                                        <br>
                                        <img id="preview" width="500px"/>
                                        <input type="file" class="form-control" onchange="tampilkanPreview(this,'preview')" name="foto" placeholder="Gambar">
                                    </div>
                                    <div class="form-group">
