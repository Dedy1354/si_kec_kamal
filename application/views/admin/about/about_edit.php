                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-info-sign"></i>Edit Data About
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                ...
                                foreach ($temp as $tem) {
                                    ?>
                                    <form action="<?php echo base_url(); ?>index.php/admin/C_admin/simpan_about" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <img id="preview" src="<?php echo base_url()."assets/uploads/about/".$tem->foto; ?>" width="500px"/>
                                            <input type="file"  class="form-control" accept="image/*"  onchange="tampilkanPreview(this,'preview')" name="foto">
                                        </div>
                                        <div class="form-group">
