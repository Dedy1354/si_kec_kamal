  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
          <div class="box">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Laporan Pembuatan Data</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-folder-open"></i> Laporan Pembuatan data
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/laporan_ksk"> 
                                                    <div class="col-xs-3">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/laporan_sp"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-duplicate"></i>
                                                </div>
                                                    <div class="panel-footer">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/laporan_akte"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-duplicate"></i>
                                                </div>
                                                    <div class="panel-footer">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/laporan_ktp"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-duplicate"></i>
                                                </div>
                                                    <div class="panel-footer">
