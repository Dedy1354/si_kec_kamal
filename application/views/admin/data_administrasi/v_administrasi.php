                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/tabel_ksk"> 
                                                    <div class="col-xs-3">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/tabel_sp"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                </div>
                                                    <div class="panel-footer">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/tabel_akte"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                </div>
                                                    <div class="panel-footer">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <div class="row">
                                                ...
                                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/tabel_ktp"> 
                                                    <div class="col-xs-3">
                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                </div>
                                                    <div class="panel-footer">
