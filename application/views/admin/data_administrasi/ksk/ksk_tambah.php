                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-folder-open"></i> Tambah Data KSK
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                            <form action="<?php echo base_url();?>index.php/admin/C_admin/ksk" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="pemohon" placeholder="Isi Nama Pemohon" required>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nama" placeholder="Nama KSK" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Alamat Lengkap</label>
                              <input type="text" class="form-control" name="alaml" placeholder="Alamat lengkap" required>
                            </div>
                            <div class="form-group">
