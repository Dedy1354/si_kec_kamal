                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url();?>index.php/admin/C_admin/tambah_ktp" method="POST">
                                    <div class="form-group">
                                      <label for="formGroupExampleInput">Tanggal</label>
                                      <input type="date" class="form-control" name="tgl" placeholder="Isi tgl Pemohon" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" onkeypress="return isNumberKey(event,this)" name="nik" placeholder="isi no nik" required>
                                    </div>
                                    <div class="form-group">
