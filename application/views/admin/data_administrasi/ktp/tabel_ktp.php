                          ...
                          <div class="panel-body table-responsive">
                            ...
                            <tr>
                                ...
                                <td scope="col"><?php echo $tem->tgl;?></td>
                                  ...
                                  <td scope="col">
                                  <a href="<?php echo base_url().'index.php/admin/C_admin/ktp_edit/'.$tem->no;?>"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a href="<?php echo base_url().'index.php/admin/C_admin/ktp_hapus/'.$tem->no;?>"onclick="return confirm('Anda yakin akan menghapus data ini... ?')"><i class="glyphicon glyphicon-trash"></i></a></td>
                                    </tr>                               
                              <?php
                                }
                              }
                            ...
                            <?php echo form_open (base_url().'index.php/admin/C_admin/ktp_tambah'); ?>
                            <td colspan="10"><button class="btn btn-primary" name="kskadd" value="tambah">Tambah</button></td></tr>
