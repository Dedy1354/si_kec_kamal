                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <form action="<?php echo base_url(); ?>index.php/admin/C_admin/tambah_akte" method="POST">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">NIK</label>
                                        <input type="text" class="form-control" onkeypress="return isNumberKey(event,this)" name="nik" placeholder="Nama masukkan nik" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Tanggal</label>
                                        <input type="date" class="form-control" name="tgl" placeholder="Nama masukkan tanggal" required>
                                    </div>
                                    <div class="form-group">
