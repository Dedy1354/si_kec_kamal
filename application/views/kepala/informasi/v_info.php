                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-user"></i> <strong>Data Kepala</strong>
                            </div>
                            <!-- /.panel-heading -->
                          <div class="panel-body">
                              <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        echo form_open (base_url().'index.php/', ['class'=>'']);
                                        if (count($temp) < 1) {
                                            ?>
                                            ...
                                            <td scope="col"><a href="<?php echo base_url().'index.php/kepala/C_kepala/user_edit/'.$tem->nik;?>"><i class="glyphicon glyphicon-pencil"></i></a>
                                           </td>
                                            </tr>                               
                                            <?php
                                        }
