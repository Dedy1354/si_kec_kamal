                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-duplicate"></i> <strong>Laporan Pembuatan Surat Pindah</strong>
                            </div>
                            <!-- /.panel-heading -->
                          <div class="panel-body">
                            <table class="table table-bordered">
                            <div>
                                <a href="<?php echo base_url(); ?>index.php/admin/C_admin/export_laporan_sp"><i class="glyphicon glyphicon-download-alt"></i></a>
                            </div>
                              <thead>
                                <tr>
                                  <th scope="col">No</th>
