          ...
          <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- /. ROW  -->
                                ...
                                <h3><font color = #6495ED> Permohonan Pembuatan KSK </font></h3>
                                  <p>
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-folder-open"></i> Form Data KSK
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                            <form action="<?php echo base_url();?>index.php/public/C_public/ksk" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nama" placeholder="Nama KSK">
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Alamat Lengkap</label>
                              <input type="text" class="form-control" name="alaml" placeholder="Alamat lengkap">
                            </div>
                            <div class="form-group">
