          ...
          <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- /. ROW  -->
                                ...
                                <h3><font color = #6495ED> Permohonan Pembuatan Akte </font></h3>
                                  <p>
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-folder-open"></i> Form Data Akte
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                           <form action="<?php echo base_url(); ?>index.php/public/C_public/tambah_akte" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ayah" placeholder="Nama Ayah Kandung">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Nama Ibu</label>
                                        <input type="text" class="form-control" name="ibu" placeholder="Nama Ibu Kandung">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="anak" placeholder="Nama Anak">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Tempat Lahir</label>
                                        <input type="text" class="form-control" name="tmp" placeholder="Tempat Kelahiran">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Tanggal Lahir</label>
                                        <input type="date" class="form-control" name="tgl_l" placeholder="Tanggal Kelahiran">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Pekerjaan Orang Tua</label>
                                        <input type="text" class="form-control" name="pot" placeholder="Pekerjaan Orang tua (ayah/ibu)">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Anak Ke-</label>
                                        <input type="text" class="form-control" name="anak_k" placeholder="anak ke (angka)">
                                    </div>
                                    <div class="form-group">
