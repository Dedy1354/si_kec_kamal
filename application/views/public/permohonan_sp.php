                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-folder-open"></i> Form Data Surat Pindah
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           
                          
                           <form action="<?php echo base_url(); ?>index.php/public/C_public/surat_pindah" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tempat" placeholder="Kota KeLahiran">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="np" placeholder="Nomor Pengantar">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Jumlah Pengikut</label>
                                        <input type="text" class="form-control" name="jp" placeholder="Jumlah Pengikut">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Alamat Pindah</label>
                                        <input type="text" class="form-control" name="almp" placeholder="Alamat Pindah">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Alasan Pindah</label>
                                        <input type="text" class="form-control" name="alasan" placeholder="Alasan Pindah">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Tanggal Pindah</label>
                                        <input type="date" class="form-control" name="tgl_p" placeholder="Tanngal Pindah">
                                    </div>
                                    <div class="form-group">
