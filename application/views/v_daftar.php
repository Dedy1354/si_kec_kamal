...
<body class="hold-transition login-page" style="background-image : url(<?php echo base_url()?>/assets/kamal.jpg); background-repeat: no-repeat; background-size:cover;">
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg"><b>ISI NIK,NAMA DAN PASSWORD UNTUK MENDAFTAR</b></p>
    
    <form name="daftar" action="" method="post" onsubmit='return validateForm()'>

      <div class="form-group has-feedback">
        <input type="text" class="form-control" id="nik" onkeypress="return isNumberKey(event,this)" placeholder="NIK" name="nik">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" id="nama" onkeypress="return isChar(event,this)" placeholder="Nama" name="nama">
    ...
    ?>
    <p><b>Anda Berhasil Mendaftar Pada Sistem Silahkan Login Pada Halaman <a href="<?php echo base_url('index.php/C_login'); ?>">ini.</a></b></p>
    <?php
        }else{
    ?>
    <p><b>Anda Gagal Mendaftar NIK sudah ada, silahkan reload halaman ini</b></p>
    <?php
