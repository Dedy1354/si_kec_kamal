                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                foreach ($temp as $tem) {
                                    ?>
                                    <form action="<?php echo base_url().'index.php/user/C_user/kskedits/'.$tem->no;?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tgl" value="<?php echo $tem->tgl; ?>" readonly>
                                        </div>
                                        <div class="form-group">
