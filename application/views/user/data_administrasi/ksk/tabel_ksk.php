                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <div class="form-group">
                             <a href="<?php echo base_url()."index.php/user/C_user/tambah_ksk"; ?>" class="btn btn-primary">Tambah</a>
                            </div> 
                             <table class="table table-bordered">
                              ...
                              <?php
                                echo form_open ('admin/C_admin/ksk', ['class'=>'']);
                              if(count($temp) < 1){
                                ?>
                            ...
                            <tr>
                                ...
                                <td scope="col"><?php echo $no;?></td>
                                  ...
                                  <td scope="col"><?php echo $tem->tgl;?></td>   
                                        <td scope="col"><a href="<?php echo base_url().'index.php/user/C_user/kskedit/'.$tem->no;?>"><i class="glyphicon glyphicon-pencil"></i></a>
                                            <a href="<?php echo base_url().'index.php/user/C_user/kskhapus/'.$tem->no;?>" onclick="return confirm('Anda yakin akan membatalkan permohomonan pembuatan ksk, jika ya maka data akan terhapus... ?')"><i class="glyphicon glyphicon-trash"></i></a>
                                            <a target="_blank" href="<?php echo base_url().'index.php/user/C_user/cetak_ksk/'.$this->enkripsi->encode($tem->no);?>"><i class="glyphicon glyphicon-print"></i></a>
                                            </td> 
                                    </tr>                               
                              <?php
                                }
